<!-- Filename: Help6.x:Menu_Item_Metadata  / Display title: Métadonnées des Élément de Menu -->
...
![pestaña de metadatos del elemento de menú](../../../es/images/menu-items-common/menu-item-metadata/01-metadata-tab.png)
