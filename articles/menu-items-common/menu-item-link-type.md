<!-- Filename: Help6.x:Menu_Item_Link_Type  / Display title: Type de lien de l'élément de menu -->
...
![tipo de enlace del elemento del menú](../../../es/images/menu-items-common/menu-item-link-type/01-menu-item-link-type.png)
