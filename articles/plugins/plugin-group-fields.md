<!-- Filename: Chunk4x:Extensions_Plugin_Manager_Edit_Fields_Group  / Display title: Groupe des Champs -->
...
![Formulario del plugin de campos casillas de verificación](../../../en/images/plugins/plugin-group-fields/01-checkboxes.png)
...
![Formulario del plugin de campos editor](../../../en/images/plugins/plugin-group-fields/02-editor.png)
...
![Formulario del plugin campo lista de imágenes](../../../en/images/plugins/plugin-group-fields/03-imagelist.png)
...
![Formulario del plugin campo entero](../../../en/images/plugins/plugin-group-fields/04-integer.png)
...
![Formulario del plugin campo lista](../../../en/images/plugins/plugin-group-fields/05-list.png)
...
![Formulario del plugin campo medios](../../../en/images/plugins/plugin-group-fields/06-media.png)
...
![Formulario del plugin campo radio](../../../en/images/plugins/plugin-group-fields/07-radio.png)
...
![Formulario del plugin campo SQL](../../../en/images/plugins/plugin-group-fields/08-sql.png)
...
![Formulario del plugin campo texto](../../../en/images/plugins/plugin-group-fields/09-text.png)
...
![Formulario del plugin campo área de texto](../../../en/images/plugins/plugin-group-fields/10-textarea.png)
...
![Formulario del plugin campo URL](../../../en/images/plugins/plugin-group-fields/11-url.png)
...
![Formulario del plugin campo lista de grupos de usuarios](../../../en/images/plugins/plugin-group-fields/12-usergrouplist.png)
