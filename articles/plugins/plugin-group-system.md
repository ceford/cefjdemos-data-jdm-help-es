...
![Formulario de funciones adicionales de accesibilidad del sistema](../../../en/images/plugins/plugin-group-system/01-additional-accessibility-features.png)
...
![Formulario de depuración del sistema pestaña de plugin](../../../en/images/plugins/plugin-group-system/02-debug-plugin-tab.png)
...
![Formulario de depuración del sistema pestaña de idioma](../../../en/images/plugins/plugin-group-system/03-debug-language-tab.png)
...
![Formulario de depuración del sistema pestaña de registro](../../../en/images/plugins/plugin-group-system/04-debug-logging-tab.png)
...
![Formulario de encabezados http del sistema](../../../en/images/plugins/plugin-group-system/05-http-headers.png)
...
![Formulario de planificador de tareas del sistema](../../../en/images/plugins/plugin-group-system/06-job-scheduler.png)
...
![Formulario de estadísticas de joomla](../../../en/images/plugins/plugin-group-system/07-joomla-statistics.png)
...
![Formulario de notificación de actualización de joomla](../../../en/images/plugins/plugin-group-system/08-joomla-update-notification.png)
...
![Formulario de filtro de idioma del sistema](../../../en/images/plugins/plugin-group-system/09-language-filter.png)
...
![Formulario de rotación de registros del sistema](../../../en/images/plugins/plugin-group-system/10-log-rotation.png)
...
![Formulario de caché de página del sistema](../../../en/images/plugins/plugin-group-system/11-page-cache.png)
...
![Formulario de consentimiento de privacidad del sistema](../../../en/images/plugins/plugin-group-system/12-privacy-consent.png)
...
![Formulario de consentimiento de privacidad del sistema pestaña de expiración](../../../en/images/plugins/plugin-group-system/13-consent-expiration.png)
...
![Formulario de redirigir del sistema](../../../en/images/plugins/plugin-group-system/14-redirect.png)
...
![Formulario de sef del sistema](../../../en/images/plugins/plugin-group-system/15-sef.png)
...
![Formulario de purga de datos de sesión del sistema](../../../en/images/plugins/plugin-group-system/16-session-data-purge.png)
...
![Formulario de saltar a la navegación del sistema](../../../en/images/plugins/plugin-group-system/17-skip-to-navigation.png)

### Sistema - Registro de Acciones de Usuarios

![Formulario de registro de acciones de usuarios del sistema](../../../en/images/plugins/plugin-group-system/18-user-actions-log.png)
...
![Formulario de registro de usuarios del sistema](../../../en/images/plugins/plugin-group-system/19-user-log.png)
