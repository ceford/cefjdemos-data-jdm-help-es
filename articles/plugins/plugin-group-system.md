...
![Formulario de funciones adicionales de accesibilidad del sistema](../../../en/images/plugins/plugin-group-system/01-plugin-group-system-additional-accessibility-features.png)
...
![Formulario de depuración del sistema pestaña de plugin](../../../en/images/plugins/plugin-group-system/02-plugin-group-system-debug-plugin-tab.png)
...
![Formulario de depuración del sistema pestaña de idioma](../../../en/images/plugins/plugin-group-system/03-plugin-group-system-debug-language-tab.png)
...
![Formulario de depuración del sistema pestaña de registro](../../../en/images/plugins/plugin-group-system/04-plugin-group-system-debug-logging-tab.png)
...
![Formulario de encabezados http del sistema](../../../en/images/plugins/plugin-group-system/05-plugin-group-system-http-headers.png)
...
![Formulario de planificador de tareas del sistema](../../../en/images/plugins/plugin-group-system/06-plugin-group-system-job-scheduler.png)
...
![Formulario de estadísticas de joomla](../../../en/images/plugins/plugin-group-system/07-plugin-group-system-joomla-statistics.png)
...
![Formulario de notificación de actualización de joomla](../../../en/images/plugins/plugin-group-system/08-plugin-group-system-joomla-update-notification.png)
...
![Formulario de filtro de idioma del sistema](../../../en/images/plugins/plugin-group-system/09-plugin-group-system-language-filter.png)
...
![Formulario de rotación de registros del sistema](../../../en/images/plugins/plugin-group-system/10-plugin-group-system-log-rotation.png)
...
![Formulario de caché de página del sistema](../../../en/images/plugins/plugin-group-system/11-plugin-group-system-page-cache.png)
...
![Formulario de consentimiento de privacidad del sistema](../../../en/images/plugins/plugin-group-system/12-plugin-group-system-privacy-consent.png)
...
![Formulario de consentimiento de privacidad del sistema pestaña de expiración](../../../en/images/plugins/plugin-group-system/13-plugin-group-system-privacy-consent-expiration.png)
...
![Formulario de redirigir del sistema](../../../en/images/plugins/plugin-group-system/14-plugin-group-system-redirect.png)
...
![Formulario de sef del sistema](../../../en/images/plugins/plugin-group-system/15-plugin-group-system-sef.png)
...
![Formulario de purga de datos de sesión del sistema](../../../en/images/plugins/plugin-group-system/16-plugin-group-system-session-data-purge.png)
...
![Formulario de saltar a la navegación del sistema](../../../en/images/plugins/plugin-group-system/17-plugin-group-system-skip-to-navigation.png)

### Sistema - Registro de Acciones de Usuarios

![Formulario de registro de acciones de usuarios del sistema](../../../en/images/plugins/plugin-group-system/18-plugin-group-system-user-actions-log.png)
...
![Formulario de registro de usuarios del sistema](../../../en/images/plugins/plugin-group-system/19-plugin-group-system-user-log.png)
