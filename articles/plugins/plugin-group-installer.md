<!-- Filename: Chunk4x:Extensions_Plugin_Manager_Edit_Installer_Group  / Display title: Groupe d'installation -->
...
![Establecer el orden de la pestaña de instalación desde la web](../../../en/images/plugins/plugin-group-installer/01-install-from-web-order.png)
