<!-- Filename: Help4.x:Contacts:_Categories  / Display title: Contacts : Catégories -->
...
![lista de categorías de contactos](../../../es/images/contacts/contacts-categories/01-categories-list.png)
