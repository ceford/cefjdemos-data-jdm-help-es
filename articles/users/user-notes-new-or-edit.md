<!-- Filename: Help4.x:User_Notes:_New_or_Edit  / Display title: Notes de l'utilisateur : Nouveau ou Modifier -->
...
![usuarios notas de usuario nuevas o editar](../../../es/images/users/user-notes-new-or-edit/01-edit-form.png)
