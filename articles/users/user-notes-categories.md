<!-- Filename: Help4.x:User_Notes:_Categories  / Display title: Notes de l'utilisateur : Catégories -->
...
![lista de notas de usuarios](../../../es/images/users/user-notes-categories/01-users-user-notes-categories-list.png)
