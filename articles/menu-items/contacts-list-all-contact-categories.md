...
![Elemento del Menú Lista de Contactos Todas las Categorías árbol pestaña de detalles](../../../es/images/menu-items/contacts-list-all-contact-categories/01-details-tab.png)
...
![Elemento de Menú Lista de Contactos Todas las Categorías árbol pestaña de categorías](../../../es/images/menu-items/contacts-list-all-contact-categories/02-categories-tab.png)
...
![Elemento de Menú Lista de Contactos Todas las Categorías árbol pestaña de opciones de visualización de contacto](../../../es/images/menu-items/contacts-list-all-contact-categories/03-contact-display-options.png)
...
![Elemento de Menú Lista de Contactos Todas las Categorías árbol pestaña de opciones de correo](../../../es/images/menu-items/contacts-list-all-contact-categories/04-mail-options-tab.png)
