<!-- Filename: Help4.x:Menu_Item:_Password_Reset  / Display title: Réinitialisation du mot de passe -->
...
![Detalles de restablecimiento de contraseña](../../../es/images/menu-items/users-password-reset/01-details-tab.png)
