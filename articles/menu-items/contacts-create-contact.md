<!-- Filename: Help4.x:Menu_Item:_Create_Contact  / Display title: Créer un contact -->
...
![Elemento del Menú Crear Contacto](../../../es/images/menu-items/contacts-create-contact/01-details-tab.png)
