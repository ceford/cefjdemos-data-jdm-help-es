<!-- Filename: Help4.x:Menu_Item:_Username_Reminder_Request  / Display title: Demande de rappel de nom d'utilisateur -->
...
![Pestaña de detalles del perfil del usuario](../../../es/images/menu-items/users-username-reminder-request/01-details-tab.png)
