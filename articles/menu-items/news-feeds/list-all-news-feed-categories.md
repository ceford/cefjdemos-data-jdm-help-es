...
![Lista de todos los ítems de Menú en la pestaña de detalles de Categorías de Noticias](../../../../es/images/menu-items/news-feeds/list-all-news-feed-categories/01-details-tab.png)

## Campos del Formulario

### Pestaña de Categorías

![Lista de Elementos del Menú todas las Categorías del Feed de Noticias pestaña de categorías](../../../../es/images/menu-items/news-feeds/list-all-news-feed-categories/02-categories-tab.png)
...
![Lista de Elementos del Menú todas las Categorías del Feed de Noticias pestaña de opciones de visualización de feeds](../../../../es/images/menu-items/news-feeds/list-all-news-feed-categories/03-feed-display-options-tab.png)
