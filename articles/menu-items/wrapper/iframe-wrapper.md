...
![Pestaña de detalles del envoltorio del iframe](../../../../es/images/menu-items/wrapper/iframe-wrapper/01-details-tab.png)

## Campos del Formulario

### Pestaña de Parámetros de Barras de Desplazamiento

![Pestaña de parámetros de barras de desplazamiento del envoltorio de IFrame](../../../../es/images/menu-items/wrapper/iframe-wrapper/02-scroll-bar-parameters-tab.png)
...
![Pestaña avanzada del envoltorio de IFrame](../../../../es/images/menu-items/wrapper/iframe-wrapper/03-advanced-tab.png)
