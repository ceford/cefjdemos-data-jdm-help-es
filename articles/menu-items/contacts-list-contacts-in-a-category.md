<!-- Filename: Help4.x:Menu_Item:_List_Contacts_in_a_Category  / Display title: Lister les contacts dans une catégorie -->
...
![Lista de elementos del menú Contactos en la pestaña de detalles de una categoría](../../../es/images/menu-items/contacts-list-contacts-in-a-category/01-details-tab.png)
...
![Elemento de Menú Lista Contactos en una Categoría pestaña de categoría](../../../es/images/menu-items/contacts-list-contacts-in-a-category/02-category-tab.png)
...
![Elemento de Menú Lista Contactos en una Categoría pestaña de visualización de contacto](../../../es/images/menu-items/contacts-list-contacts-in-a-category/03-featured-contacts-form-tab.png)
...
![Elemento de Menú Lista Contactos en una Categoría pestaña de opciones de correo](../../../es/images/menu-items/contacts-list-contacts-in-a-category/04-featured-contacts-mail-options-tab.png)
