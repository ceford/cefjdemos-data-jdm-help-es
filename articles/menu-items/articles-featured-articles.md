<!-- Filename: Help4.x:Menu_Item:_Featured_Articles / Display title: Artículos Destacados -->
...
![Ítem de Menú Artículos Destacados detalles](../../../es/images/menu-items/articles-featured-articles/01-details-tab.png)
