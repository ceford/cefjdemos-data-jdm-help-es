<!-- Filename: Help4.x:Menu_Item:_Featured_Contacts  / Display title: Contacts en vedette -->
...
![Elemento de Menú Detalles de Contactos Destacados](../../../es/images/menu-items/contacts-featured-contacts/01-details-tab.png)

## Campos del Formulario

### Pestaña del Formulario

![Pestaña del formulario de contactos destacados en el menú](../../../es/images/menu-items/contacts-featured-contacts/02-form-tab.png)
...
![Pestaña de opciones de correo de contactos destacados en el menú](../../../es/images/menu-items/contacts-featured-contacts/03-mail-options-tab.png)
