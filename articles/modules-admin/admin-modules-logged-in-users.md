<!-- Filename: Help4.x:Admin_Modules:_Logged-in_Users  / Display title: Modules : Utilisateurs connectés -->
...
![módulo de usuarios conectados en la pestaña del módulo](../../../es/images/modules-admin/admin-modules-logged-in-users/01-module-tab.png)
