<!-- Filename: Help4.x:Check-in:_Options  / Display title: Enregistrement : Options -->
...
![Opciones de check-in](../../../es/images/maintenance/check-in-options/01-permissions-tab.png)
