...
![task timeout setting](../../../es/images/maintenance/scheduled-tasks-configuration/01-configure-tasks-tab.png)

- **Tiempo de Tarea Excedido** El valor predeterminado es de 300 segundos.

### Pestaña de Programador Perezoso

![lazy schedule setting](../../../es/images/maintenance/scheduled-tasks-configuration/02-lazy-scheduler-tab.png)
...
![web cron setting](../../../es/images/maintenance/scheduled-tasks-configuration/03-webcron-tab.png)
