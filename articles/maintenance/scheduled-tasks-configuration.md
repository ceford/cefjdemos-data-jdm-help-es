<!-- Filename: Help5.x:Scheduled_Tasks:_Options / Display title: Configuración de las tareas programadas -->
...
![task timeout setting](../../../es/images/maintenance/scheduled-tasks-configuration/01-scheduled-tasks-options-configure-tasks.png)

- **Tiempo de Tarea Excedido** El valor predeterminado es de 300 segundos.

### Pestaña de Programador Perezoso

![lazy schedule setting](../../../es/images/maintenance/scheduled-tasks-configuration/02-scheduled-tasks-options-lazy-scheduler.png)
...
![web cron setting](../../../es/images/maintenance/scheduled-tasks-configuration/03-scheduled-tasks-options-webcron.png)
